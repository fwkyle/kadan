...
export function renderDashboardWorkspace({center,briefs,centerError,url,detail,works=null,workError=null,workDetail}) {
 ...
 const fields=['healthKind','healthLabel','healthReason','signalAt','signalLabel','key','id','repo','title','kind','workType','originalTitle','state','stateLabel','stored','purpose','flowLabel','flowPhase','flowTitle','turnLabel','turnReason','turnSource','next','summary','scope','board','owner','model','modelTitle','reportAt','reportLabel','at','revision'];
