...
// 표 줄은 화면 스크립트가 목록 자료로 그린다. 서버가 같은 줄을 한 번 더 싣던 것(실행 1,035줄 약 1.7MB)은 뺐다(2026-09-25).
