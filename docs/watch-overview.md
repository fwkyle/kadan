...
2026-09-16 원장 개편에 따른 읽음·깨움 방향과 남은 감시 보정은 [구조 기준](architecture.md)을 참조한다. 미확인 우편 감시는 아직 구현되지 않았으며, 아래 현재 감시 동작 및 HTML을 개편 완료 상태로 해석하지 않는다.
...
5분으로 늘리면 3분을 넘겨 보고하는 AI를 기다릴 수 있다. 보고 후 의도적인 연결 종료 등 모든 499를 없애는 변경은 아니다. 현재 증거·검증 범위는 [변경 기록](daily/2026-09-09/watch-observer-split.md)에 둔다.
...
변경 근거: [직접 보고 구현 기록](daily/2026-09-08/watch-ai-direct-report.md), [완료 역할 감시 제외](daily/2026-09-08/watch-active-scope.md), [종료된 실행의 상위 책임 제외](daily/2026-09-08/watch-completed-responsibility.md). 예전 낱말 응답 함수는 과거 API 호환 시험용으로 남아 있으며 실제 `kadan watch`는 사용하지 않는다.
...
구현·검증 기록: [감독 응답 점검](daily/2026-09-09/supervisor-health.md).
